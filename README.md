...
I enjoy working on technically challenging problems where machine learning has to move beyond research prototypes and become something scalable, reliable, and useful in practice.
...
At **Bluesky International Ltd, a Woolpert Company** (as a KTP Associate with the **University of Leicester** and **Innovate UK**), I lead the design and deployment of large-scale machine learning pipelines for segmentation and classification. My work includes:

- Scaling workflows from single-instance processing to **54,000-instance workloads**
...
**Bluesky International Limited** | KTP Associate with University of Leicester & Innovate UK  
**Feb 2025 – Present**

- Led national-scale AI pipelines for segmentation and classification
...
- Author of **31+ peer-reviewed publications**
...
- Applied AI and ML in production
- Computer vision and remote sensing
- Geospatial intelligence
- Satellite and LiDAR data analysis
...
- Experimental and applied research code
